...
public class PahlawanData {
    ...
    public static ArrayList<PahlawanModel> getListData(){
        ...
        for (int i=0;i <heroNames.length;i++){
            ...
            pahlawanModel.setHeroImages(heroesImages[i]);
            pahlawanModel.setHeroNames(heroNames[i]);
            pahlawanModel.setHeroDetails(heroDetails[i]);
